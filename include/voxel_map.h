...
public:
  ...
  void pubVoxelMap(const rclcpp::Node::SharedPtr nh);
...
private:
  ...
  void pubSinglePlane(const rclcpp::Node::SharedPtr nh,visualization_msgs::msg::MarkerArray &plane_pub, const std::string plane_ns, const VoxelPlane &single_plane, const float alpha,
