...
public:
  ...
  void process(const std::shared_ptr<livox_ros_driver2::msg::CustomMsg> &msg, PointCloudXYZI::Ptr &pcl_out);
  void process(const std::shared_ptr<sensor_msgs::msg::PointCloud2> &msg, PointCloudXYZI::Ptr &pcl_out);
...
private:
  void avia_handler(const std::shared_ptr<livox_ros_driver2::msg::CustomMsg> &msg);
  void oust64_handler(const std::shared_ptr<sensor_msgs::msg::PointCloud2> &msg);
  void velodyne_handler(const std::shared_ptr<sensor_msgs::msg::PointCloud2> &msg);
  void xt32_handler(const std::shared_ptr<sensor_msgs::msg::PointCloud2> &msg);
  void Pandar128_handler(const std::shared_ptr<sensor_msgs::msg::PointCloud2> &msg);
  void l515_handler(const std::shared_ptr<sensor_msgs::msg::PointCloud2> &msg);
