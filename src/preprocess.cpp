...
void Preprocess::process(const std::shared_ptr<livox_ros_driver2::msg::CustomMsg> &msg, PointCloudXYZI::Ptr &pcl_out)
{
  avia_handler(msg);
  *pcl_out = pl_surf;
}

void Preprocess::process(const std::shared_ptr<sensor_msgs::msg::PointCloud2> &msg, PointCloudXYZI::Ptr &pcl_out)
{
  switch (lidar_type)
  {
  case OUST64:
...
void Preprocess::avia_handler(const std::shared_ptr<livox_ros_driver2::msg::CustomMsg> &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
...
void Preprocess::l515_handler(const std::shared_ptr<sensor_msgs::msg::PointCloud2> &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
...
void Preprocess::oust64_handler(const std::shared_ptr<sensor_msgs::msg::PointCloud2> &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
...
void Preprocess::velodyne_handler(const std::shared_ptr<sensor_msgs::msg::PointCloud2> &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
...
void Preprocess::Pandar128_handler(const std::shared_ptr<sensor_msgs::msg::PointCloud2> &msg)
{
  pl_surf.clear();
...
void Preprocess::xt32_handler(const std::shared_ptr<sensor_msgs::msg::PointCloud2> &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
